...
public class SwipePattern {
	...
	public void swipe() throws MalformedURLException {
		...
		driver.swipe((int)(w*0.25), 0, (int)(w*0.25), h, 1500);
		driver.swipe((int)(w*0.5), 0, (int)(w*0.5), h, 1500);
		driver.swipe((int)(w*0.75), 0, (int)(w*0.75), h, 1500);
		driver.swipe(0, (int)(h*0.5), w, (int)(h*0.5), 1500);
		driver.swipe(0, (int)(h*0.25), w, (int)(h*0.75), 1500);
		driver.swipe(0, (int)(h*0.75), w, (int)(h*0.75), 1500);
	}
}
